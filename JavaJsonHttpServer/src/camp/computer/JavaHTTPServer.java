...
public class JavaHTTPServer {
    ...
    public JavaHTTPServer() throws IOException {
        ...
        httpServer.createContext("/jsonPost", new JsonPostHandler());

        httpServer.createContext("/repository/actions", new JsonGetActionsHandler());
    ...
    public class JsonPostHandler implements HttpHandler {
...
//                        actionScripts.put(actionTitle, actionScript);
    ...
    public class JsonGetActionsHandler implements HttpHandler {
